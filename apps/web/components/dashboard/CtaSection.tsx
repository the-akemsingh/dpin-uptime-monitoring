export function CtaSection() {
  return (
    <div className="my-16 flex justify-center">
      <div className="relative overflow-hidden rounded-2xl border border-zinc-800 bg-[#111] p-12 text-center md:pb-20 md:pt-16 md:px-24 mx-auto w-full max-w-4xl shadow-xl">
